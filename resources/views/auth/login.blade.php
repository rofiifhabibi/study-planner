...
<body class="bg-[#FAF8F5] min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-[420px] bg-white rounded-[32px] border border-[#F0EAE1] p-8 shadow-sm">
        ...
        <div class="grid grid-cols-2 gap-3">
            ...
            <a href="{{ route('auth.telegram.redirect') }}" class="flex items-center justify-center gap-2 bg-[#F5F2ED] hover:bg-[#ECE6DE] text-gray-800 text-xs font-medium py-3 px-4 rounded-full border border-transparent transition">
