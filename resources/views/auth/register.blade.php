...
<body class="bg-[#FAF8F5] min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-[420px] bg-white rounded-[32px] border border-[#F0EAE1] p-8 shadow-sm">
        ...
        <div class="space-y-2.5">
            <a href="{{ route('auth.google.redirect') }}" class="w-full flex items-center justify-center gap-2.5 bg-[#F5F2ED] hover:bg-[#ECE6DE] text-gray-800 text-xs font-semibold py-3 px-4 rounded-full transition">
            ...
            <a href="{{ route('auth.telegram.redirect') }}" class="w-full flex items-center justify-center gap-2.5 bg-[#229ED9] hover:bg-[#1C8CBF] text-white text-xs font-semibold py-3 px-4 rounded-full transition shadow-sm">
